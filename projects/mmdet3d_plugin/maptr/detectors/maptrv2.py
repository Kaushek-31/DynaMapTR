...
class MapTRv2(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        encoder_module = self.pts_bbox_head.transformer.encoder
        if (gt_depth is not None and depth is not None and
                hasattr(encoder_module, 'get_depth_loss')):
            loss_depth = encoder_module.get_depth_loss(gt_depth, depth)
